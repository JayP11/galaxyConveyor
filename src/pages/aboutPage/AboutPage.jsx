...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Galaxy Conveyor | About</title>
      </Helmet>
      <div
        style={{
        ...
        <div
          ...
          <div className="About_certificate_list_main">
            ...
            <div className="about_galaxy_conveyor_main">
              ...
              <div className="about_intro_para_main">
                <p>
                  Galaxy Conveyors Pvt. Ltd., your trusted partner in the world
                  of conveyor chains. With a relentless commitment to quality
                ...
                <br />
                <p>
                  Our mission is to be more than a supplier; we’re your
                  dedicated partner in the journey to optimized conveyor
                  performance.
                </p>
              </div>
            </div>
