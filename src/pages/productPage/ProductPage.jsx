...
const ProductPage = () => {
  ...
  const category = [
    {
      id: 1,
      name: "Steel Fabricated Chains",
      list: [
        {
          id: 1,
          name: "Large Roller Type",
          img: require("../../assets/RollerChain1.png"),
          category: "British Standard",
        },
        {
          id: 2,
          name: "Small Roller Type",
          img: require("../../assets/RollerChain2.png"),
          category: "British Standard",
        },
        {
          id: 3,
          name: "Flanged Roller Type",
        ...
        {
          id: 5,
          name: "Welded Bushed Type",
          img: require("../../assets/RollerChain4.png"),
          category: "American Standard",
        },
        {
          id: 6,
          name: "Flow Conveyor Type",
          img: require("../../assets/RollerChain4.png"),
          category: "American Standard",
        },
        {
          id: 7,
          name: "Bottling Conveyor Chain",
          img: require("../../assets/RollerChain4.png"),
          category: "American Standard",
        },
        {
          id: 8,
          name: "Solid & Hollow Bearing Pin Type",
          img: require("../../assets/RollerChain4.png"),
          category: "American Standard",
        },
      ],
    ...
    {
      id: 3,
      name: "Roller Chains And Attachments",
      list: [
        {
          id: 1,
          name: "Roller Chains",
        ...
        {
          id: 2,
          name: "Single Pitch Attachment",
          img: require("../../assets/Factory_img.png"),
        },
        {
          id: 3,
          name: "Extended Pitch Attachment",
          img: require("../../assets/Factory_img.png"),
        },
        {
          id: 4,
